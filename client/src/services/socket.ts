...
// Lazily connect (once) using the same JWT the REST layer uses. Host matches the
// hard-coded API base in services/api.ts. The server authenticates the handshake
